 ...
 * 2015-04-20T00:41:42.981+10:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "TopDownSimpleServiceImplService", 
                  wsdlLocation = "http://localhost:8080/TopDownSimpleService/TopDownSimpleService?wsdl",
...
public class TopDownSimpleServiceImplService extends Service {
    ...
    public final static QName SERVICE = new QName("http://marketservice.soacourse.unsw.edu.au/", "TopDownSimpleServiceImplService");
    public final static QName TopDownSimpleServiceImplPort = new QName("http://marketservice.soacourse.unsw.edu.au/", "TopDownSimpleServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/TopDownSimpleService/TopDownSimpleService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TopDownSimpleServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/TopDownSimpleService/TopDownSimpleService?wsdl");
        }
        WSDL_LOCATION = url;
    }
